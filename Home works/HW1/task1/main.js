...
text.setAttribute = ('id', 'style');
text.style.cssText = 'width:200px;height:200px;-moz-border-radius:100px;border:1px  solid #ddd;-moz-box-shadow: 0px 0px 8px  #fff;';

document.body.appendChild(text);

document.body.style.backgroundColor = getRandomIntInclusive();
document.querySelector(".colorclass").innerHTML = 
  document.body.style.backgroundColor;

function ClickButn(event) {
  document.body.style.backgroundColor = getRandomIntInclusive();
  document.querySelector(".colorclass").innerHTML =
